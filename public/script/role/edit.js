...
function InitForm() {
    ...
    $.when(ajaxRoleFeature(roleID)).done(function (data) {
        ...
        $('#dt-feature').DataTable({
            ...
            columns: [{
                ...
                },
                {
                    data: 'feature_id',
                    render: function (data, type, row, meta) {
                        var btnEditHtml = '<center><a href="#" data-toggle="tooltip" data-id="' + row.feature_id + '" data-placement="right" title data-original-title="' + lang.delete + '" type="button" class="btn-delete"><i style="color:grey;" class="mdi dripicons-cross font-size-18 align-middle mr-2"></i></a></center>';
                        return btnEditHtml;
                    },
                },
...
function ajaxRoleFeature(role_id) {
    var link = urlPage + "/getrolefeature/" + role_id;
    return $.ajax({
        url: link,
        type: 'GET',
        success: function (data) {
