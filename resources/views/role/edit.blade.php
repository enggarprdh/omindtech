...
@section('container')
<script src="{{asset('script/role/edit.js')}}" type="text/javascript"></script>
...
<script>
    ...
    var urlSaveRole = "{{route('update_role')}}";
    var lang = {
                ...
                <div class="page-title-box d-flex align-items-center justify-content-between">
                    ...
                    <div class="page-title-left">
                        <a href="{{url('/role')}}" class="btn btn-outline-primary waves-effect waves-light">
                          ...
                          <h4 class="mb-0 font-size-18">@lang('role.edit_role')</h4>
                </div>
            </div>
        </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <form id="form1" method="POST" action="/role">
                                    @csrf
                                    <div class="form-group position-relative">
                                        <label for="code">@lang('role.code')</label>
                                        <input type="hidden" id="roleid" name="roleid" value="{{$role->id}}" />            
                                        <input type="text" class="form-control" id="code" name="code" placeholder="Enter Role Code" value="{{$role->code}}"/>
                                        ...
                                        <table id="dt-feature" class="table table-centered table-nowrap mb-0 clean-table">
                                            <thead class="thead-light">
                                                <tr>
                                                    ...
                                                    <th style="padding:6px;" width="30%">@lang('basic.feature')</th>
                                                    ...
                                                    <th class="table-title" width="10%">@lang('basic.action')</th>
                                                </tr>
                                            </thead>
                                        </table>
                                    </div>
